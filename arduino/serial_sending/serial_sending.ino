...
void loop() {
  if (mySerial.available()) {
    ...
    if ((digitalRead(A1)==1 or digitalRead(A2)==1) and pages_up==0){
      page=0;
      pages_up=1;
      lcd.setCursor(0, 0);
      lcd.print("                ");
    ...
    else if(digitalRead(A1)==1 and page!=4 and pages_up==1){
      page+=1;
      lcd.setCursor(0, 0);
      lcd.print("                ");
      lcd.setCursor(0, 1);
    ...
    else if(digitalRead(A2)==1 and page!=0 and pages_up==1){
      page-=1;
      lcd.setCursor(0, 0);
      lcd.print("                ");
      lcd.setCursor(0, 1);
